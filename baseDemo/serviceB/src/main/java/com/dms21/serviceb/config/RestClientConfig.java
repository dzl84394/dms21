package com.dms21.serviceb.config;
 ...
 *   2) @LoadBalanced 的 builder    —— 给业务调用 serviceA 用
...
public class RestClientConfig {
    ...
    /**
     * 业务 RestClient，baseUrl 用 service-a（Eureka 中的服务名）
     * 参数上的 @LoadBalanced 必须加，否则会拿到 @Primary 的普通 builder
     *
     * 使用示例：
     *   serviceARestClient.get().uri("/hello").retrieve().body(String.class);
     */
    @Bean
